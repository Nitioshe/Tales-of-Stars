...
def Bank(player, inventory, CraftingSystem, player_zone):
  load_zone('Zones\\bank.json')
  print("What do you want to do ?\n1-Go somewhere else\n2-Deposit\n3-Withdraw\n4-See your inventory")
  choice = input("Enter your choice: ")
  if choice == "1":
    return Tettno_main(player, inventory, CraftingSystem, player_zone)
  elif choice == "2":
    return  #deposit
  elif choice == "3":
    return  #withdraw
    ...
    return Bank(player, inventory, CraftingSystem, player_zone)

def Adventurers_guild(player, inventory, CraftingSystem, player_zone):
  ...
  if choice == "1":
    ...
    if choice2 == 1:
      ...
      if kafka == 1:
        ...
        print(f"Kafka : I see")
        return Adventurers_guild(player, inventory, CraftingSystem,
                                 player_zone)
      else:
        return Adventurers_guild(player, inventory, CraftingSystem,
                                 player_zone)
...
def Forest(player, inventory, CraftingSystem, player_zone):
...
def battle(player, monster, player_zone, inventory):
  poison = 0
  stun = 0
  print("Battle Start!")
  while player.health > 0 and monster.health > 0:
    ...
    if choice == "1":
      ...
      if player.mana >= 10:
        ...
        crit = random.randint(0, 100)
        if crit >= 90:
          player.attack = random.randint(player.attack * 3,
          ...
          jouer_bruit('Sound Effect\\magic-sound.mp3')
          print(
              f"{player.name} casts a magic attack on {monster.name} for {player.attack} damage."
          )
      else:
  ...
  if forest_flag == 0:
    ...
    while combat_count < max_combats:  # Boucle pour les combats successifs
      ...
      if combat_count == max_combats:
        ...
        return Tettno_main(player, player_inventory, CraftingSystem,
                           player_zone)

  else:
    return Tettno_main(player, player_inventory, CraftingSystem, player_zone)
...
def Tettno_main(player, inventory, CraftingSystem, player_zone):
  ...
  if choice == "1":
    ...
    for craft in possible_crafts:
      print(possible_crafts)
      print(
          "Enter the name of the craft you want to perform, or 'back' to go back:"
      )
      craft_choice = input()
      if craft_choice == "back":
        return Adventurers_guild(player, inventory, CraftingSystem,player_zone)
    ...
    if choice2 == 1:
      ...
      return Forest(player, inventory, CraftingSystem, player_zone)
    elif choice2 == 3:
      return Adventurers_guild(player, inventory, CraftingSystem, player_zone)
  else:
    return Tettno_main(player, inventory, CraftingSystem, player_zone)
